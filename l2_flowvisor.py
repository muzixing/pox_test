...
def _handle_PacketIn (event):
  ...
  if dst_port is None:
    ...
    for p in event.connection.ports:
      ...
      msg.actions.append(of.ofp_action_output(port = p))#we record the port.

    event.connection.send(msg)#send the msg
    ...
    msg.actions.append(of.ofp_action_output(port = dst_port))#output the packet and record the output port.
    event.connection.send(msg)
